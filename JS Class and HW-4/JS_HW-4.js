...
function income_tax(salary, tax_rate){
    ...
    document.writeln(`Yearly Salary of the Employee is ${yearly_salary} and according to Govt. rules, this is a taxable income and he have to pay ${tax_rate}% tax from his annual income`);
    document.writeln('<br>')
